...
const MILESTONES = [
  { year: "จุดเริ่มต้น", title: "รากฐานจากครอบครัวน้ำแข็งกว่า 40 ปี", desc: "ธนมนเริ่มต้นจากครอบครัวที่อยู่ในธุรกิจน้ำแข็งในกรุงเทพมหานครมากว่า 40 ปี สั่งสมความรู้ ความชำนาญ และความเข้าใจในงานจัดจำหน่ายน้ำแข็งอย่างลึกซึ้ง ก่อนนำประสบการณ์ทั้งหมดมาต่อยอดสู่การให้บริการในพื้นที่มหาชัย สมุทรสาคร" },
