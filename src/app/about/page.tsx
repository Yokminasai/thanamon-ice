...
export const metadata: Metadata = {
  title: "เกี่ยวกับเรา",
  description: `โรงงานน้ำแข็งธนมน มหาชัย — ผู้ผลิตและจัดจำหน่ายน้ำแข็งโม่ น้ำแข็งก้อน น้ำแข็งยูนิต ในพื้นที่มหาชัยและสมุทรสาคร`,
  alternates: { canonical: `${SITE.url}/about` },
};

const MILESTONES = [
  { year: "ก่อตั้ง", title: "เริ่มต้นธุรกิจในมหาชัย", desc: "ก่อตั้งโรงงานน้ำแข็งธนมนในพื้นที่มหาชัย สมุทรสาคร ด้วยทุนและความตั้งใจของครอบครัว" },
  { year: "ขยาย", title: "เพิ่มกำลังการผลิต", desc: "ลงทุนเครื่องจักรผลิตน้ำแข็งเพิ่มเติม รองรับลูกค้าที่เพิ่มขึ้นในพื้นที่สมุทรสาคร" },
  ...
  return (
    <>
      <PageHero
        label="About Us"
        title="เกี่ยวกับเรา"
        description="โรงงานน้ำแข็งธนมน มหาชัย — ผู้ผลิตและจัดจำหน่ายน้ำแข็งคุณภาพสำหรับธุรกิจ"
        ...
        <div className="container-content">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <SectionHeader
                label="ประวัติบริษัท"
                title="โรงงานน้ำแข็งธนมน มหาชัย"
              ...
              <div className="space-y-4 text-warm-700 text-sm leading-relaxed">
                <p>โรงงานน้ำแข็งธนมนก่อตั้งขึ้นในพื้นที่มหาชัย จังหวัดสมุทรสาคร ด้วยเป้าหมายเดียวคือการเป็นผู้ผลิตน้ำแข็งที่ธุรกิจในท้องถิ่นวางใจได้</p>
                <p>เราผลิตน้ำแข็งโม่ น้ำแข็งก้อน และน้ำแข็งยูนิต จากน้ำที่ผ่านกระบวนการกรองและฆ่าเชื้อตามมาตรฐาน รับประกันความสะอาดและความปลอดภัยทุกชิ้น</p>
            ...
            <div className="relative h-72 md:h-80 lg:h-96 overflow-hidden border border-warm-200">
              <Image
                ...
                alt="การผลิตน้ำแข็งคุณภาพ" fill className="object-cover"
